...
#     Boolean which describes whether the device supports Wi-Fi to Cellular.
{
    ...
    GET_BUILD_VAR "TARGET_BONE_KERNEL_ENABLED" "false"
    GET_BUILD_VAR "TARGET_BONE_KERNEL_MODE" "release"
    GET_BUILD_VAR "TARGET_BONE_KERNEL_SOURCE_DIR" "none"
    GET_BUILD_VAR "TARGET_BONE_KERNEL_BRANCH" "ksu-next-susfs-oneui"
    GET_BUILD_VAR "TARGET_BONE_KERNEL_REPO" "bone-machine/android_kernel_samsung_sm7325_a52s_5g"
    GET_BUILD_VAR "TARGET_BONE_KERNEL_RELEASE_URL" "https://github.com/bone-machine/android_kernel_samsung_sm7325_a52s_5g/releases/download/v3.2.0-legacy/bone-machine_One-UI_KSU-Next-v3.2.0-legacy_SUSFS_a52sxq.zip"
    GET_BUILD_VAR "TARGET_ARTISAN_HFR_TWEAKS_ENABLED" "false"
